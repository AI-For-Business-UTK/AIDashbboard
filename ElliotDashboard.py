...
# Load Data
# =========================
density_map_data = pd.read_csv("DensityMapData.csv")
top_ai_skills_data = pd.read_csv("AISkillsTab_data.csv")
top_ai_career_data = pd.read_csv("CareeerAreaStateShare.csv")   # for share
